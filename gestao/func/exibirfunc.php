...
<head>
    <meta charset="UTF-8">
    <title>Todos os Funcionários | Dueños de Pizza</title>
...
<body>
    ...
    <h1>Funcionários da Pizzaria</h1>
    <h4>Esses são todos os funcionários cadastrados:</h4>
